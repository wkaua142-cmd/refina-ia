      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center gradient-bg">
        ...
        >
          ...
          <p className="text-white/80 text-lg max-w-md">
            Melhore qualquer imagem com inteligência artificial mantendo 100% da naturalidade.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <div className="text-center lg:text-left">
            <h2 className="font-display text-3xl font-bold text-foreground">Bem-vindo de volta</h2>
            <p className="text-muted-foreground mt-2">Entre na sua conta para continuar editando</p>
          </div>
